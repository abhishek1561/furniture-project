...
$slidernameerr=$imageerr=$contenterr=$titleerr=$descriptionerr='';
if(isset($_POST['updateslider'])){
    ...
    if(empty($_POST['slidername']) || $_POST['slidername']==''){
        ...
        $query="UPDATE  slider SET sliderName='$slidername',content='$content',title='$title',image='$imagename' WHERE s_id=$id";
