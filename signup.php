                    ...
                    <div class="col-lg-12">
                        <div class="col-lg-4">
                            <input type="submit" name="signup"
                                class="btn  mb-3 px-4 rounded-pill text-white news-field bg-dark" value="Sign Up"
                        ...
                        <div class="col-lg-6">
                            <p class="haveAccount">If you have any account?<b><a href="signIn.php">Sign In</a></b>
                            </p>
                        </div>
                    </div>
                </form>
